    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; text-align: center; padding: 20px;">
          ...
          <a href="${process.env.FRONT_URL}/auth/confirm-account" style="display: inline-block; margin-top: 20px; background-color: #4F46E5; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
            Confirm Account
          </a>
